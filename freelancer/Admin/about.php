	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>settings<small>section</small></h1>
          <ol class="breadcrumb">
        ...
        <section class="content">	 
		 ...
		 <div class="col-lg-12">
          ...
          <div class="col-lg-4">
	         ...
	         <a href="about.php?a=details" class="list-group-item<?php echo $selected; ?>">
	          <em class="fa fa-fw fa-info-circle text-white"></em>&nbsp;&nbsp;&nbsp;'about details
			 </a>
	         <a href="about.php?a=headerimg" class="list-group-item">
	          <em class="fa fa-fw fa-image text-white"></em>&nbsp;&nbsp;&nbsp; about header image settings
			 </a>
	         <a href="about.php?a=hello" class="list-group-item<?php echo $hello; ?>">
	          <em class="fa fa-fw fa-info-circle text-white"></em>&nbsp;&nbsp;&nbsp;about hello
			 </a>
	         <a href="about.php?a=whitebg" class="list-group-item<?php echo $whitebg; ?>">
	          <em class="fa fa-fw fa-info-circle text-white"></em>&nbsp;&nbsp;&nbsp;about tagline
			 </a>
	         <a href="about.php?a=teamtag" class="list-group-item<?php echo $teamtag; ?>">
	          <em class="fa fa-fw fa-plus-square text-white"></em>&nbsp;&nbsp;&nbsp;team']; ?> <?php echo $lang['tagline']; ?>
			 </a>
	         <a href="about.php?a=team" class="list-group-item<?php echo $team; ?>">
	          <em class="fa fa-fw fa-users text-white"></em>&nbsp;&nbsp;&nbsp;team
			 </a>
	         <a href="about.php?a=timelinetag" class="list-group-item">
	          <em class="fa fa-fw fa-plus-square text-white"></em>&nbsp;&nbsp;&nbsp;timeline tagline
			 </a>
	         <a href="about.php?a=timeline" class="list-group-item">
	          <em class="fa fa-fw fa-bars text-white"></em>&nbsp;&nbsp;&nbsp;timeline
			 </a>
              ...
              <div class="box box-info">
                 ...
                 <form role="form" method="post"> 
                  ...
                  <div class="form-group">	
                   ...
                   <div class="input-group">
                    ...
                    <textarea type="text" name="about_top_title" class="form-control" rows="3">site
							about_top_title
                  ...
                  <div class="box-footer">
                    ...
                    <button type="submit" name="site" class="btn btn-primary full-width">submit</button>
                  </div>
                 </form> 
                </div><!-- /.box-body -->
              </div><!-- /.box -->
                ...
                <form role="form" method="post" enctype="multipart/form-data">
                  ...
                  <div class="box-footer">
                    ...
                    <button type="submit" name="picture" class="btn btn-primary full-width">submit</button><br></br>
                  </div>
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">edit about hello</h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post"> 
                  <input type="hidden" name="sid" value=""/>
                  ...
                  <div class="form-group">	
				    <label>hello</label>
                      <textarea type="text" id="summernote" name="about_hello" class="form-control">abthello
							 'about_hello
                  ...
                  <div class="box-footer">
                    <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                    <button type="submit" name="abthello" class="btn btn-primary full-width">submit</button>
                  </div>
                 </form> 
                </div><!-- /.box-body -->
              </div><!-- /.box -->
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">edit bout tagline</h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post"> 
                  <input type="hidden" name="sid" value=""/>
                  <div class="form-group">	
                   ...
                   <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                    <textarea type="text" name="about_whitebg" class="form-control" rows="5">
                         </textarea>
                   </div>
                  </div>
                  ...
                  <div class="box-footer">
                    <input type="hidden" name="token" value="" />
                    <button type="submit" name="abtwhitebg" class="btn btn-primary full-width">submit</button>
                  </div>
                 </form> 
                </div><!-- /.box-body -->
              </div><!-- /.box -->   
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">edit team tagline</h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post"> 
                  <input type="hidden" name="sid" value=""/>
                  <div class="form-group">	
                   ...
                   <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                    <textarea type="text" name="teamtagline" class="form-control" rows="3"></textarea>
                   </div>
                  </div>
                                   
                  <div class="box-footer">
                    <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                    <button type="submit" name="team_tagline" class="btn btn-primary full-width">submit</button>
                  </div>
                 </form> 
                </div><!-- /.box-body -->
              </div><!-- /.box -->  
