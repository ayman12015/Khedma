	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>job invite<small>section</small></h1>
          <ol class="breadcrumb">
            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i>home</a></li>
            <li class="active">job invite list</li>
          </ol>
        </section>
		 ...
		 <div class="row">	
		 	<div class="col-md-12">
                ...
                <div class="box-header">
                  <h3 class="box-title">job invite list</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					  ...
					  <tr>
					   ...
					   <td><a href="">desgin website Web Developement</a></td>
					  ...
					  <td><span class="label label-success"> acceptance </span> </td>
					  <td><span class="label label-success"> active</span> </td>
					   ...
					   <td>
					      ...
					      <a href="" class="btn btn-primary btn-xs" data-toggle="tooltip" title=""><span class="fa fa-eye"></span></a>
					      </td>
					  </tr>
