...
<body class="greybg">
  ...
  text-align: center;"
	 <?php } ?>>
      ...
      <div class="container">
		...
		<h3 class="banner-description"><?php echo $down_title; ?></h3>
		 ...
		 <!-- <form action="" method="get" class="list-s">
		  <button>Search</button>
		  <input type="text" class="form-control" name="searchterm" placeholder="Tell us what freelane service you need e.g Design a Company Logo.." value=""/>   
		  <div class="clearfix"></div>
		 </form>
		<p>trending services: Web, Software & IT , Design, Art & Multimedia , Writing & Translation
        	</p> -->
	 ...
	 <section class="stats">
	  <div class="container">
       <div class="row">
        ...
        <br />
        <?php
        $query = DB::getInstance()->get("job", "*", ["AND"=>["active"=>1,"
        	delete_remove" => 0]]);
        if ($query->count() ===''){
        	$jobsposted = 0;
	   ...
	   if ($q3->count() === '') {
        ...
        ?>
       <!--here you get job info from database using mysql-->
       <div class="row"> 
     ...
     <!-- Khedma JS -->
     <script src="assets/js/khedma.js" type="text/javascript"></script>
