	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>invitation section</small></h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> home</a></li>
            <li class="active">add an invite</li>
          </ol>
        </section>
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">invite freelancer to a job</h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post" id="addform"> 
                  ...
                  <div class="form-group">	
                   ...
                   <div class="input-group">
					...
					<option value = "">Admi suport</option>
					<option value = "">Admi suport</option>
					<option value = "">Admi suport</option>
                  ...
                  <div class="form-group">	
					...
					<div class="radio">
					  <label><input type="radio" name="job_type" checked="checked" value="Fixed Price">fixed price</label>
					</div>								    
                  </div> 
                  ...
                  <div class="form-group">	
                   ...
                   <div class="input-group">
                    ...
                    <input type="text" name="budget" class="form-control" placeholder="" value=""/>
                   </div>
                  </div>       

				  <div class="form-group">
                   <label for="dtp_input1">estimated start date</label>
				  ...
				  <div class="form-group">
                   <label for="dtp_input1">estimated end date</label>
                    <div class="input-group date form_datetime_start" data-date-format="dd MM yyyy" data-link-field="dtp_input1">
				  ...
				  <div class="form-group">	
				   ...
				   <select class="selectpicker form-control" name="skills_name[]" type="text" title="Choose one of the following..." data-live-search="true" data-width="30%" data-selected-text-format="count > 3" multiple="multiple">
					 <option value = "" data-tokens="" >marketing</option>
					  <option value = "" data-tokens="" >developing</option>
                  ...
                  <div class="form-group">	
				    ...
				    <div class="checkbox">
					  ...
					  <label><input type="checkbox" name="make_public" value="1">make public</label>
					</div>								    
                  </div> 
